...
class MyApp:
    def __init__(self, root):
        self.root = root
        self.root.geometry("1024x600")  # Adjusted window size
        ...
        window_width = 920  # Adjusted window width
        window_height = 600  # Adjusted window height
        ...
        self.image_label.place(x=0, y=0, width=920, height=600)  # Adjusted image label size
        ...
        center_x_right = 920 + (1024 - 920 - button_width) / 2  # Adjusted center calculation

        self.status_label = tk.Label(self.root, text="Status:", font=("Arial", label_font_size, label_font_weight),bg="#D3D3D3")
        self.status_label.place(x=920, y=25, width=60, height=20)  # Adjusted position

        self.status_button = tk.Button(self.root, width=3, height=1, bg="#f36c60", borderwidth=0)
        self.status_button.place(x=990, y=25, width=25, height=24)  # Adjusted position
